...
event_history.add(TopUpEvent(1, 400))
event_history.add(TopUpEvent(time.time(), 400))
event_history.add(IncomingCallEvent(1, "89093465434", 76))
event_history.add(IncomingCallEvent(time.time(), "89098635162", 42))
event_history.add(RoamingEnterEvent(time.time()))
event_history.add(IncomingCallEvent(1, "89093465434", 76))
event_history.add(IncomingCallEvent(time.time(), "89098635162", 42))
...
event_history.add(MobileInternetEvent(1, 54))
